    ...
    <div class="action-card">
        ...
        <div class="action-card__form--grid">
            <label class="action-card__label action-card__label--relative">Buscar Paciente
                ...
                <div id="pacientes-sugerencias-buscar" class="sugerencias-box" style="display: none;"></div>
            </label>
        </div>

        <div id="paciente-condiciones-info-buscar" class="paciente-info-box" style="display: none;"></div>

        <div id="consultas-lista-buscar" class="consultas-lista-scroll"></div>
    </div>
    <svg class="modal-crud__boton-cerrar" name="modalBotonCerrar" data-modal="modalBuscarConsulta" fill="#000000" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 460.775 460.775">
