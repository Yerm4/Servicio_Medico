        ...
        <div id="seccion-configuracion" class="configuracion-container seccion-configuracion-box">
            <div class="nested-tabs-menu menu-subtabs">
                ...
                <?php if ($tieneGestionarCondiciones): ?>
                    <a href="#" id="sub-tab-condiciones" class="sub-tab-link subtab-link-comun subtab-link-condiciones <?= !$tieneGestionarRolesPermisos ? 'subtab-link-active' : '' ?>">Condiciones</a>
                <?php endif; ?>
                <?php if ($tieneGestionarOferta): ?>        
                    <a href="#" id="sub-tab-nucleos" class="sub-tab-link subtab-link-comun subtab-link-nucleos <?= !$tieneGestionarOferta ? 'subtab-link-active' : '' ?>">Nucleos</a>
                    <a href="#" id="sub-tab-pnf" class="sub-tab-link subtab-link-comun subtab-link-pnf <?= !$tieneGestionarOferta ? 'subtab-link-active' : '' ?>">PNFs</a>
                    <a href="#" id="sub-tab-ofertas" class="sub-tab-link subtab-link-comun subtab-link-ofertas <?= !$tieneGestionarOferta ? 'subtab-link-active' : '' ?>">Ofertas</a>
                <?php endif; ?>
            </div>
            ...
            <?php if ($tieneGestionarRolesPermisos): ?>
                ...
                <div id="sub-content-general" class="sub-tab-content subcontent-general-box configuracion-bloque-formulario">
                    ...
                    <div id="alert-container-general-config" class="alert-container"></div>
                    <form id="formGuardarConfiguracion" action="index.php" method="POST" class="form-configuracion-flex">
                        ...
                        <label class="label-rol-defecto">
                            ...
                            <select name="rol_defecto" id="selectRolDefecto" required class="action-card__select select-rol-defecto">
                                <?php 
                ...
                <div id="sub-content-roles" class="sub-tab-content subcontent-roles-box">
                    <div id="alert-container-roles" class="alert-container"></div>
                    <div class="contenedor-form-nuevo-rol">
                        <h3 class="titulo-configuracion-interna">Crear Nuevo Rol</h3>
                        <form id="formRegistrarRol" action="index.php" method="POST" class="form-configuracion-flex">
                            <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
                                ...
                                <?php foreach ($roles as $role): ?>
                                    <tr class="tr-body-consultas">
                                        ...
                                        <td>
                                            ...
                                            <form action="index.php" method="POST" class="form-eliminar-inline form-eliminar-rol">
                                                <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
                    ...
                    <form id="formRolesPermisos" action="index.php" method="POST">
                        <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
                        <input type="hidden" name="form" value="guardar_roles_permisos">
                        <div id="contenedorMatrizPermisos">
            ...
            <?php if ($tieneGestionarCondiciones): ?>
                ...
                <div id="sub-content-condiciones" class="sub-tab-content subcontent-condiciones-box" style="display: <?= $tieneGestionarRolesPermisos ? 'none' : 'block' ?>;">
                    <div class="cabecera-tabla-global">
                        <h3 class="titulo-configuracion-interna">Condiciones Registradas</h3>
                        <button type="button" class="action-card__button action-card__button--fit" name="openModal" data-modal="modalRegistrarCondicion">Registrar Condición</button>
                    </div>
                    <div id="alert-container-condiciones" class="alert-container"></div>
                            ...
                            <?php else: foreach ($condicionesRegistradas as $cond): ?>
                                <tr class="tr-body-consultas">
                                    ...
                                    <td>
                                        ...
                                        <form action="index.php" method="POST" class="form-eliminar-inline form-eliminar-condicion">
                                            <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
            ...
            <?php if ($tieneGestionarOferta): ?>
                ...
                <div id="sub-content-oferta" class="sub-tab-content subcontent-oferta-box" style="display: <?= $tieneGestionarOferta ? 'none' : 'block' ?>;">
                    <div class="contenedor-tabla-consultas">
                        <div class="cabecera-tabla-global">
                            <h3 class="titulo-tabla-consultas">Ofertas Académicas</h3>
                            <a name="openModal" data-modal="modalRegistrarOferta" class="action-card__button action-card__button--fit" href="#">Registrar Oferta Academica</a>
                        </div>
                        <div id="alert-container-oferta" class="alert-container"></div>
                                ...
                                <?php if (!empty($ofertas)): foreach ($ofertas as $o): ?>
                                    <tr class="tr-body-consultas">
                                        ...
                                        <td class="td-acciones-btn">
                                            <form id="eliminarOferta" method="POST" action="index.php" class="form-eliminar-inline">
                ...
                <div id="sub-content-nucleos" class="sub-tab-content subcontent-general-box configuracion-bloque-formulario" style="display: <?= $tieneGestionarOferta ? 'none' : 'block' ?>;">
                    <div id="sedes-carreras" class="contenedor-sedes-carreras">
                        <div class="contenedor-tabla-consultas">
                            <div class="cabecera-tabla-global">
                                <h3 class="titulo-tabla-consultas">Núcleos</h3>
                                <a name="openModal" data-modal="modalRegistrarNucleo" class="action-card__button action-card__button--fit" href="#">Registrar Nucleo</a>
                            </div>
                            <div id="alert-container-nucleo" class="alert-container"></div>
                            <table id="tablaNucleos" class="tabla-consultas">
                                <thead>
                                    <tr class="tr-head-consultas">
                                                ...
                                                <td class="td-acciones-btn">
                                                    <div class="acciones-flex">
                                                        <button class="action-card__button editar-nucleo btn-add" name="openModal" data-modal="modalActualizarNucleo" data-id="<?= e($n['id_nucleo']) ?>" data-nombre="<?= e($n['nombre_nucleo']) ?>">
                                                            <svg class="svg-icon-no-pointer" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <button class="btn-eliminar" name="eliminarNucleo" type="submit" data-id="<?=e($n['id_nucleo'])?>">
                                                            <svg class="svg-icon-no-pointer" width="30" height="30" viewBox="0 0 512 512" fill="#000000" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M316.325 44.522V0H195.68l-.003 44.522H61.217v87.982h21.616c3.975 75.409 20.548 350.983 21.319 363.803L105.097 512h301.806l.944-15.694c.771-12.821 17.345-288.394 21.319-363.803h21.616V44.522H316.325zM229.069 33.391h53.866v11.13h-53.866V33.391zM375.458 478.609H136.542c-3.633-60.548-16.681-278.597-20.27-346.105h279.456c-3.588 67.503-16.637 285.551-20.27 346.105zM417.391 99.112H94.609V77.913h322.783v21.199z"/>
                                                                <path d="M239.304 167.947h33.391v280.031h-33.391z"/>
                                                            </svg>
                                                        </button>
                ...
                <div id="sub-content-pnf" class="sub-tab-content subcontent-general-box configuracion-bloque-formulario" style="display: <?= $tieneGestionarOferta ? 'none' : 'block' ?>;">
                    <div id="contenedor-tabla-dinamica">
                        <div class="contenedor-tabla-consultas">
                            <div class="cabecera-tabla-global">
                                <h3 class="titulo-tabla-consultas">Programas de Formación Nacional (PNF)</h3>
                                <a name="openModal" data-modal="modalRegistrarPNF" class="action-card__button action-card__button--fit" href="#">Registrar PNF</a>
                            </div>
                            
                            <div id="alert-container-pnf" class="alert-container"></div>
                            
                            <table id="tablaPnfs" class="tabla-consultas">
                                <thead>
                                    <tr class="tr-head-consultas">
                                        <th class="th-consultas">ID</th>
                                        ...
                                        <tr class="tr-body-consultas">
                                            ...
                                            <td class="td-acciones-btn">
                                                <div class="acciones-flex">
                                                    ...
                                                    <button class="btn-eliminar" name="eliminarPnf" type="submit" data-id="<?= e($p['id_pnf']) ?>">
                                                        <svg class="svg-icon-no-pointer" width="30" height="30" viewBox="0 0 512 512" fill="#000000" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M316.325 44.522V0H195.68l-.003 44.522H61.217v87.982h21.616c3.975 75.409 20.548 350.983 21.319 363.803L105.097 512h301.806l.944-15.694c.771-12.821 17.345-288.394 21.319-363.803h21.616V44.522H316.325zM229.069 33.391h53.866v11.13h-53.866V33.391zM375.458 478.609H136.542c-3.633-60.548-16.681-278.597-20.27-346.105h279.456c-3.588 67.503-16.637 285.551-20.27 346.105zM417.391 99.112H94.609V77.913h322.783v21.199z"/>
                                                            <path d="M239.304 167.947h33.391v280.031h-33.391z"/>
                                                        </svg>
